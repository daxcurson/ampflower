...
public class AlbumLoadStateAdapter extends LoadStateAdapter<AlbumLoadStateAdapter.LoadStateViewHolder>
{
    @Override
    public void onBindViewHolder(@NonNull AlbumLoadStateAdapter.LoadStateViewHolder networkStateItemViewHolder, @NonNull LoadState loadState) {
