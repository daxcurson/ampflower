...
public class AlbumRemoteMediator extends RxRemoteMediator<Integer, Album>
{
    ...
    public AlbumRemoteMediator(LiveData<String> query,AmpacheService ampacheService,AmpacheDatabase ampacheDatabase)
    {
        this.query=query;
    ...
    public Single<MediatorResult> loadSingle(@NonNull LoadType loadType, @NonNull PagingState<Integer, Album> pagingState) {
        ...
        return ampacheService.albums(Objects.requireNonNull(loginResponse.getValue()).getAuth(),query.getValue(),offset,limit)
