...
import ar.com.strellis.ampflower2.databinding.ListItemNetworkStateBinding;

public class ArtistLoadStateAdapter  extends LoadStateAdapter<ArtistLoadStateAdapter.LoadStateViewHolder>
{
    @Override
    public void onBindViewHolder(@NonNull ArtistLoadStateAdapter.LoadStateViewHolder networkStateItemViewHolder, @NonNull LoadState loadState) {
        networkStateItemViewHolder.bind(loadState);
    }

    @NonNull
    @Override
    public ArtistLoadStateAdapter.LoadStateViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, @NonNull LoadState loadState) {
        return new ArtistLoadStateAdapter.LoadStateViewHolder(viewGroup,null);
    }
