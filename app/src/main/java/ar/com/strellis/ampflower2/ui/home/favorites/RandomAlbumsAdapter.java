...
public class RandomAlbumsAdapter extends PagingDataAdapter<Album,RandomAlbumsAdapter.AlbumViewHolder>
{
    private static final int LOADING_ITEM=0;
    private static final int ALBUM_ITEM=1;

    public RandomAlbumsAdapter()
    {
        super(callback_diff);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RandomAlbumsAdapter.AlbumViewHolder holder, int position) {
